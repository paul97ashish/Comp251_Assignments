...
public class mancala {
    ...
    private static final String InputFilePath = "./testMancala.txt";
    private static final String OutputFilePath = "./testMancala_solution.txt";
    private static final int CavsPerLine = 12;
    ...
    public void readFile() {
        ...
        try {
            ...
            this.listOfBoards = new int[this.numOfProblems][CavsPerLine];
